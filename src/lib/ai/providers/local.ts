...
export class LocalGroundedProviderAdapter implements AIProviderAdapter {
  ...
  async generate(req: AIProviderRequest): Promise<AIProviderResponse> {
    ...
    // ─── 3.1 ROI & COST ESTIMATION ───────────────────────────────────────────
    else if (analysis.intent === "ROI_ESTIMATION") {
      reply = isBengali
        ? `### 📊 AI অটোমেশন ও আর্কিটেকচার এস্টিমেশন গাইডলাইন\n\nআরেফিনের প্রজেক্ট প্রাইসিং সিস্টেমের জটিলতা, এপিআই ইন্টিগ্রেশন এবং টাইমলাইনের উপর নির্ভর করে:\n\n- **n8n / Zapier Workflow Automation:** $500 – $1,500 (ডেলিভারি: ১–২ সপ্তাহ)\n- **Enterprise RAG Knowledge Engine (Pinecone + LangChain):** $1,200 – $2,800 (ডেলিভারি: ২–৩ সপ্তাহ)\n- **Multi-Agent Decision Swarms (CrewAI / Python):** $1,500 – $3,500 (ডেলিভারি: ২–৪ সপ্তাহ)\n- **Full-Stack AI Web Systems (Next.js 16 + FastAPI):** $2,500 – $5,000 (ডেলিভারি: ৩–৫ সপ্তাহ)\n\nআপনার কাস্টম প্রজেক্টের বাজেট এবং টাইমলাইন নিখুঁতভাবে নির্ধারণ করতে [Schedule Discovery Call](/book) এ কথা বলুন।`
        : `### 📊 AI Workflow & Project Investment Guidelines\n\nProject investments are calibrated based on data pipeline complexity, vector retrieval scale, and integration endpoints:\n\n- **n8n / Webhook Workflow Pipelines**: $500 – $1,500 *(Timeline: 1–2 Weeks)*\n- **Enterprise RAG Knowledge Engines (Pinecone + Dense Vectors)**: $1,200 – $2,800 *(Timeline: 2–3 Weeks)*\n- **Multi-Agent Orchestration Swarms (LangGraph / Python)**: $1,500 – $3,500 *(Timeline: 2–4 Weeks)*\n- **Full-Stack AI Platforms (Next.js 16 + FastAPI + MongoDB)**: $2,500 – $5,000 *(Timeline: 3–5 Weeks)*\n\n> [!TIP]\n> Use the **ROI Estimator** button in this panel or book a scoping session to receive a formal statement of work: [Schedule 30-Min Discovery Call](/book).`;
    }
