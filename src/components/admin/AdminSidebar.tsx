...
export default function AdminSidebar({ user, unreadCount = 0 }: AdminSidebarProps) {
  ...
  return (
    <aside
      ...
      } bg-[#0b0e17] border-r border-[#1a202c] flex flex-col transition-all duration-200 shrink-0 select-none z-20`}
    >
      {/* Brand Header */}
      <div
      ...
      >
        ...
        <button
          ...
          className="p-1.5 text-[#6b7280] hover:text-white hover:bg-[#1a202c] rounded-lg transition-colors shrink-0"
